...
<body class="login">
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="form-vertical login-form" action="TPA" method="get">
			<h3 class="form-title">TPA Login</h3>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="TPA Name" name="tpa"/>
					</div>
				</div>
			</div>
			<div class="control-group">
