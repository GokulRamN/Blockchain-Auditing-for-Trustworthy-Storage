...
<body>
  ...
  <tr>
   ...
   <%
                                ...
                                try {
                                    ResultSet rs = st.executeQuery("Select * from dataowner where kgc='waiting' ");
                                    while (rs.next()) {
                            %>
  <tr>
     ...
     <td><a href="sendkey.jsp?mid=<%=rs.getString("email")%>&time=<%=rs.getString("time")%>&doid=<%=rs.getString("id")%>" style="color:seagreen ">Send Key</a></td>
  </tr>
   <%                                        }
                                } catch (Exception ex) {
                                    ex.printStackTrace();
