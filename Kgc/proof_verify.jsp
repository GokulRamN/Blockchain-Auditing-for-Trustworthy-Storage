...
<body>
    <h1>Uploaded File Validation</h1> <form method="get" action="proof_check.jsp">
...
<div class="pwdForm">
  <form onsubmit="return checkForm(this);">
    ...
    <div>
        <input placeholder="Hash value Uploaded" type="text" name="pwd1" value="<%=hash1%>">
    </div>
    <div>
        <input placeholder="Hash Value Proof" type="text" name="pwd2" value="<%=rs.getString("hashcode")%>">
    </div>
    <div>
