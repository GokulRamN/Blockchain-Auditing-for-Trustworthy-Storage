...
<body class="login">
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="form-vertical login-form" action="KGC" method="get">
			<h3 class="form-title">Login to KGC</h3>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="KGC ID" name="kgcid"/>
					</div>
				</div>
			</div>
			<div class="control-group">
