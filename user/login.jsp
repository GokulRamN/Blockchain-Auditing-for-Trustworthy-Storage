...
<head>
	<meta charset="utf-8" />
	<title>Data Owner Login Form</title>
...
<body class="login">
	...
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="form-vertical login-form" action="login1.jsp" method="post">
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="email" autocomplete="off" placeholder="Enter Your Mail" name="mail"/>
					</div>
				</div>
			</div>
			<div class="control-group">
			...
			<div class="create-account">
				<p>
					Don't have an account yet ?&nbsp; 
                                        <a href="javascript:;" id="register-btn" style="color: red" >Create an account</a>
				</p>
			</div>
		</form>
		<!-- END LOGIN FORM -->        
		...
		<form class="form-vertical register-form" action="signup1.jsp" method="get">
			<h3>Sign Up</h3>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-font"></i>
                                                <input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="Full Name" name="name"/>
					</div>
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				<label class="control-label visible-ie8 visible-ie9">D.O.B</label>
				<div class="controls">
					<div class="input-icon left">
				...
				<div class="row-fluid">
					...
					<div class="controls">
                                            <div class="input-icon left">
						<select name="gender" class="span12 select2">
				...
				<div class="controls">
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="Phone Number" name="phone"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="text" autocomplete="off" placeholder="City/Town" name="city"/>
					</div>
				</div>
			</div>
			<div class="control-group">
	...
	<!-- END LOGIN -->
	<!-- BEGIN COPYRIGHT -->
	<div class="copyright"> Login Form
	</div>
	<!-- END COPYRIGHT -->
